...
import com.epam.eremenko.second_part.taskTwo_upgradeSalaryEmulator.entity.Employee;
...
public class EmployeeService {
    ...
    private static final ApplicationContext CONTEXT =
            new ClassPathXmlApplicationContext("TaskFiveServices.xml");
    private final static Logger LOGGER = LoggerFactory.getLogger(EmployeeService.class);
    private final Map<String, Employee> employees = new HashMap<>();

    public void hire(String name, Position position) {
        Employee employee = CONTEXT.getBean("hiringEmployee" , Employee.class);
        employees.put(name, nameEmployee(name, getEmployee(position, employee)));
    ...
    @NonNull
    private Employee getEmployee(Position position, Employee employee) {
